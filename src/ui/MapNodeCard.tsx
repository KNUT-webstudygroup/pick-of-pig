...
function MapNodeCard({ index, node }: MapNodeCardProps) {
  ...
  return (
    <>
      <GlobalStyle />
      <MapNodeContainer image={node.photo}>
        <MapNodeContent>
          <MapNodeTitle>
            <MapNodeIndex>
              {index}
